...
def executar_testes_extremos():
    ...
    # 1. TESTE DE SINAL CONSTANTE (Isoelétrico)
    ...
    # 2. TESTE DE RUÍDO E LIMITES (Out of Bounds)
    ...
    # 3. TESTE DE PADRÃO ALTERNANTE ESTRITO
    # Sobe e desce exatamente os mesmos valores sem parar (ex: 5, -5, 5, -5...)
